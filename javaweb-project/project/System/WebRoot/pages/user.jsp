	...
	<div id="app">
		...
		<g-modal :name="'add'" ref="addModel">
			...
			<div class="ui form">
				...
				<div class="field">
					<label>卡号</label>
					<input type="text" v-model="addModel.num" placeholder="卡号">
				</div>
				<div class="field">
					<label>姓名</label>
				...
				<div class="field">
					<label>注册日期</label>
					<input type="text" v-model="addModel.registerdate" placeholder="注册日期">
				</div>
				<div class="field">
					<label>用户等级</label>
					<input type="text" v-model="addModel.level" placeholder="用户等级">
				</div>
				<div class="field">
					<label>地址</label>
		...
		<g-modal :name="'edit'" ref="editModel">
			...
			<div class="ui form">
					...
					<div class="field">
						<label>卡号</label>
						<input type="text" v-model="editModel.num" placeholder="卡号">
					</div>
					<div class="field">
						<label>姓名</label>
				...
				<div class="field">
					...
					<div class="field">
						<label>注册日期</label>
						<input type="text" v-model="editModel.registerdate" placeholder="注册日期">
					</div>
					<div class="field">
						<label>用户等级</label>
						<input type="text" v-model="editModel.level" placeholder="用户等级">
					</div>
					<div class="field">
						<label>地址</label>
