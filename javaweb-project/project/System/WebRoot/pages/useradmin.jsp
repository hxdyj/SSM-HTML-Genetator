	...
	<div id="app">
        ...
        <div class="index-content">
            <div class="index-content-left">
                <g-left-menu :list="list_leftMenu" :active="'用户管理员'"></g-left-menu>
            </div>
            <div class="index-content-right">
                <g-breadcrumb :two="'用户管理员'"></g-breadcrumb>
    ...
    var app = new Vue({
        ...
        methods: {
			...
			getModulePage(){
				...
				return G.http('useradmin/search.do',params).then(resp=>{
					...
					this.list = resp.data
					console.log('%c%s','color:#00A29A;font-weight:600','useradmin--LIST:',this.list)
				})
			},
			del(item){
				this.$refs.loading.loading(G.http('useradmin/del.do',{id:item.id}).then(resp=>{
			...
			add(){
				...
				this.$refs.loading.loading(G.http('useradmin/add.do',this.addModel).then(resp=>{
			...
			edit(){
				...
				this.$refs.loading.loading(G.http('useradmin/edit.do',this.editModel).then(resp=>{
